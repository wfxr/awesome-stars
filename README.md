...
- [Jafaral/bmon](https://github.com/Jafaral/bmon) - bandwidth monitor and rate estimator
...
- [SKeyerror/reading-source-code-of-leveldb-1.23](https://github.com/SKeyerror/reading-source-code-of-leveldb-1.23) - leveldb 源码阅读，分析 DB 运作流程与 WAL、SSTable 等文件格式与 Compaction 过程。
...
- [mpenet/spandex](https://github.com/mpenet/spandex) - Elasticsearch client for Clojure (built on new ES 9.x java client)
...
- [lanx-x/VRouter](https://github.com/lanx-x/VRouter) - 一个基于 VirtualBox 和 openwrt 构建的项目, 旨在实现 macOS / Windows 平台的透明代理.
...
- [transformrs/ata](https://github.com/transformrs/ata) - Ask the Terminal Anything (ATA): ChatGPT in the terminal
...
- [epilande/ccmux](https://github.com/epilande/ccmux) - 🔮 Run all your AI coding agents (Claude Code, Codex, Cursor, ...) in tmux: jump to the one that needs you, spawn them into worktrees, and hand work between them
